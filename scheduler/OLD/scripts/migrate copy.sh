...
TRG_CID=$(ssh -i /home/erwin_erwinrussel_com/.ssh/id_rsa erwin_erwinrussel_com@${TRG_IP} "sudo docker create ${SRC_IMG}")
...
ssh -i /home/erwin_erwinrussel_com/.ssh/id_rsa erwin_erwinrussel_com@${TRG_IP} "sudo mount -t nfs -o vers=4 -o resvport ${SRC_IP}:/opt/checkpoints/${SRC_CID}  /var/lib/docker/containers/${TRG_CID}/checkpoints"
...
chmod -R 777 /opt/checkpoints/${SRC_CID}
ssh -i /home/erwin_erwinrussel_com/.ssh/id_rsa erwin_erwinrussel_com@${TRG_IP} "sudo docker start --checkpoint=cr1 ${TRG_CID}"
# end_time=$(date +%s.%3N)
# elapsed=$($end_time - $start_time)
# echo "- Migration succesful in: ${elapsed} seconds."
echo "- Logs:"
ssh -i /home/erwin_erwinrussel_com/.ssh/id_rsa erwin_erwinrussel_com@${TRG_IP} "sudo docker logs ${TRG_CID}"
